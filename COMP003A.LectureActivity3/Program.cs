    ...
    namespace COMP003A.LectureActivity3
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("******************************************");
            Console.WriteLine("condditional (selection) statements");
            Console.WriteLine("******************************************");
            /**************************************************************/
            ...
            if (inputNumber % 2 == 0)
            {
                // this code block exectes if the condition about is true 
                Console.WriteLine("\tinputNumber is even.");
            }
            else
            {
            ...
            if (inputNumber % 2 == 0)
            {
                // this code block exectes if the above condition is true
            ...
            Console.WriteLine("6. comparision operators");
            ...
            switch (inputNumber)
            {
                ...
                case 3:
                    // this code block exectes if the case condition is true
                    Console.WriteLine("\tinputNumber is divisible by 3.");
                    break;
